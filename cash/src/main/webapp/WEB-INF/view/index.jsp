...
<body>
	...
	<div class="container">
		...
		<!-- 공지 -->
		<div>
			<h3 style="text-align:center;">공지사항</h3> <a href="${pageContext.request.contextPath}/admin/noticeList/1" class="btn btn-outline-primary btn-sm"style="float: right;">더보기</a>
		</div>
		<div>
